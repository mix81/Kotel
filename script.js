...
function connect() { mqtt.connect({ userName: cfg.u, password: cfg.w, useSSL: true, onSuccess: () => { mqtt.subscribe("heater/#"); mqtt.subscribe("dom/#"); }, onFailure: () => setTimeout(connect, 5000) }); }
